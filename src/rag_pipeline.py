...
# Use a FAISS-specific persist directory
FAISS_PERSIST_DIR = CHROMA_PERSIST_DIR.parent / "faiss_index"
...
class KnowledgeRetriever:
    ...
    4. Store in FAISS for vector search
    ...
    def __init__(self, persist_directory: Path = None):
        ...
        """
        self.persist_dir = persist_directory or FAISS_PERSIST_DIR
