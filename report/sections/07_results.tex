...
Latency figures are end-to-end (full pipeline including state inference and
RAG retrieval) and reflect the typical range observed during interactive use
of the deployed system on a CPU-only laptop.
